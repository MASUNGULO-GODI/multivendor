...
import qrcode from '../../asssets/Qrcode.png';
import './Footer.css';
const Footer = () => {
  return (
          ...
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              <div className="col-md-3 col-lg-2 col-xl-3 mx-auto mb-4">
                <h6 className="text-uppercase fw-bold mb-4">E-shopping</h6>
                <p className="subscribe">Subscribe</p>
                <p className="order">Get 10% off your first order</p>
                <div className="send">
                <input type="email" placeholder='Enter Your Email' className='input'/>
                <button className='bi-send' style={{backgroundColor:'transparent'}}>
                <i>
  ...
  <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
              ...
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>Unit A5, 260 Surrey Ave, Ferndale, Randburg, 2194</p>
                <p>info@ikusasatech.com</p>
                <p>010 824 1153/54</p>
              </div>
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                <h6 className="text-uppercase fw-bold mb-4">Account</h6>
                <p><Link to={'/'} className="text-reset">My Account</Link></p>
                <p className="text-reset"><Link to="/Login" className="text-reset">Login</Link>/<Link to={'/Register'} className="text-reset">Register</Link> </p>
                <p className="text-reset"><Link to="/cart" className="text-reset">Cart</Link></p>
                <p className="text-reset"><Link to="/wishlist" className="text-reset">Wishlist</Link></p>
              ...
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>Save R30 with App New User Only</p>
  ...
  <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854zm4.943 12.248V6.169H2.542v7.225zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248S2.4 3.226 2.4 3.934c0 .694.521 1.248 1.327 1.248zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225z"/>
        ...
        <div className="text-center p-4" style={{ backgroundColor: "rgba(0, 0, 0, 0.05)" }}>
          © Copyright Ikusasa Technology Solutions 2025. All rights reserved.
        </div>
      </footer>
    </div>
  );
