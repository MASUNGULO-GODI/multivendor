...
const Products = () => {
  ...
  const fetchNewCollection = async () => {
    try {
      const res = await fetch('http://localhost:3000/NewCollections');
  ...
  return (
    <div className='Products'>
      <div className="title1">
        <img src={rect_icon} alt="Product category" width="18" height="45" />
