...
const BSP = () => {
  ...
  const addToWishlist = (itemId) => {
    ...
    if (localStorage.getItem('auth-token')) {
      fetch('http://localhost:3000/Addtowishlist', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className='BSP'>
      <div className="title1">
        <img src={rect_icon} alt="Decoration" width="18" height="45" />
        ...
        {allproducts.map((product) => (
          <div key={product.id} className='product-card'>
            ...
            <div className="add_cart_favorite">
              <button className="Add_to_cart" onClick={() => addTocart(product.id)}>
                Add to cart
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l1.313 7h8.17l1.313-7zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2"/>
                </svg>
              </button>
              <button className="favorite" onClick={() => addToWishlist(product.id)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
